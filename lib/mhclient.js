...
class MyHomeClient {
    ...
    onCommand(_frame) {
        // State queries are answered on the command connection. Decode them with
        // the same parser used by the monitor so HomeKit receives confirmations.
        this.onMonitor(_frame);
    }
}
